...
var _swiper_default = __webpack_require__(4);

var _swiper_default2 = _interopRequireDefault(_swiper_default);

var _footable = __webpack_require__(8);

var _footable2 = _interopRequireDefault(_footable);

var _btnUp = __webpack_require__(9);
...
$(function () {
  (0, _header2.default)();
  (0, _swiper_default2.default)();
  //table();
  (0, _footable2.default)();
  (0, _btnUp2.default)();
});
    ...
    $('.slider').each(function (index) {
      ...
      if (slider.hasClass('slider-fade')) {
        ...
        var set = (_set = {
          ...
          delay: 80000
        }), _defineProperty(_set, 'watchOverflow', true), _defineProperty(_set, 'navigation', {
          nextEl: '.btn-next',
          prevEl: '.btn-prev'
        }), _set);
      }
...
/* harmony import */ var ssr_window__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/**
 * Swiper 4.3.3
...
exports.default = fooTable;


function fooTable() {
  //console.log('footable');

  $('.js-adapt-table').footable({
    "breakpoints": {
      "small": 300,
      "xs": 600,
      "medium": 700,
  ...
  $(".js-adapt-table").find("tbody tr").hover(function () {
    $(this).find('td').addClass('hover').end().prev().find('td').addClass('hover');
  }, function () {
    $(this).find("td").removeClass('hover').end().prev().find('td').removeClass('hover');
  });
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(2)))
